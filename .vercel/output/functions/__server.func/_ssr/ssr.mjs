...
import { A as executeRewriteInput, B as isNotFound, D as resolveManifestAssetLink, E as getStylesheetHref, F as isResolvedRedirect, I as parseRedirect, O as resolveManifestCssLink, P as isRedirect, T as getScriptPreloadAttrs, a as isSsrResponse, b as require_jsx_runtime, c as stripSsrResponseBody, d as RouterProvider, i as disposeSsrResponseDetached, j as invariant, k as _getRenderedMatches, n as bindSsrResponseToRequest, o as normalizeSsrResponse, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, z as rootRouteId } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DC8nUN5Z.mjs");
...
var manifest = { "fd27ee49b0882b132bf38ff8591a07a84eb7a4dd0bdfadec1fbf745a29e1db4f": {
	functionName: "generateRandomIssue_createServerFn_handler",
	importer: () => import("./generate-issue-BU5m1NW4.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CeWzRE1_.mjs").then((n) => n.t),
