...
export const ISSUES: Issue[] = [
  ...
  },
  {
    ...
    "scenario": "Nimbus Software bán các thuê bao một nền tảng mà công ty tự phát triển, lưu trữ và kiểm soát. Công ty tự định giá, là bên ký hợp đồng với khách hàng và chịu trách nhiệm về tín dụng dịch vụ (service credits). Ba đối thủ niêm yết lớn hơn ghi nhận doanh thu trên cơ sở hoa hồng ròng (net commission) và do đó trình bày biên lợi nhuận % cao hơn trên một doanh thu nhỏ hơn. Giám đốc tài chính của Nimbus đã đề xuất chuyển Nimbus sang cùng cơ sở ròng để tăng khả năng so sánh với nhóm ngang hàng và để giúp nhà đầu tư định giá chúng ta theo cùng bội số. Phân tích pháp lý các hợp đồng của chính Nimbus vẫn kết luận rằng Nimbus là bên chính (principal). Không ai cho rằng bản chất kinh tế cơ bản đã thay đổi. Tờ trình nói ghi gross “làm người sử dụng rối vì biên % thấp hơn đối thủ” (Understandability); rằng chênh lệch gross/net 220 triệu CU “chỉ là trình bày, dưới 1% vốn hóa” nên Trọng yếu (Materiality) không đặt ra; rằng viết lại hệ thống billing tốn 1,4 triệu CU và ba tháng (Cost constraint, Timeliness). Chi tiết nhiễu: Nimbus có một mảng nhỏ marketplace chiếm 6% doanh thu, nơi công ty thật sự là agent; mảng đó đã ghi net đúng. Ban quản trị muốn “đồng bộ” toàn bộ sang net “cho một chính sách.” Email CFO ngày 9 tháng 11: “đối thủ multiple trên net revenue. Nếu ta ở gross, ta trông đắt. Chuyển.”",
